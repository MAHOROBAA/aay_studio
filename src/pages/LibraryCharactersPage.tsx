...
const CHARACTERS: CharacterCardData[] = [
  { id: 'c1', name: '김햄찌', summary: '동글동글 골든 햄스터 · 흰 셔츠 · 빨간 넥타이', meta: '참고 이미지 3장 · 2026.07.27 수정' },
  { id: 'c2', name: '진주씨', summary: '검은 단발머리 · 베이지색 셔츠', meta: '참고 이미지 2장 · 2026.07.26 수정' },
  { id: 'c3', name: '팀장님', summary: '짙은 회색 정장 · 붉은 넥타이', meta: '대표 이미지 1장 · 2026.07.24 수정' },
  { id: 'c4', name: '모카', summary: '갈색 푸들 · 파란색 스카프', meta: '참고 이미지 3장 · 2026.07.22 수정' },
  { id: 'c5', name: '콩이', summary: '둥근 얼굴의 흰 토끼 · 노란 가방', meta: '참고 이미지 2장 · 2026.07.20 수정' },
  { id: 'c6', name: '리오', summary: '주황빛 작은 여우 · 초록색 후드', meta: '대표 이미지 1장 · 2026.07.18 수정' },
]
        ...
        {CHARACTERS.map((character) => (
          ...
          >
            ...
            <div className={styles.cardBody}>
              ...
              <p className={styles.cardMeta}>{character.meta}</p>
            </div>
          </button>
        ))}
      </div>
